...
greater_pos = np.where(x>y)
equal_pos = np.where(x==y)
...
## Output
<img width="1173" height="261" alt="image" src="https://github.com/user-attachments/assets/c6a20d78-2c3d-4e15-a07f-c351f2bcf2f6" />
